...
def globalcity_temperature_process(
...
def upload_parquet_files_to_s3(output, s3_bucket):
    config = get_config("dl.cfg")
    access_key = 'AKIAYNK4YEZGTVDNTMI2'
    secret_key = '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'
...
def main():
    ...
    config = get_config("dl.cfg")
    process_tables = (
        globalcity_temperature_process,
        process_demographic,
    ...
    #upload_parquet_files_to_s3(output,s3_bucket)
